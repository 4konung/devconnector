...
import {addExpereriance} from '../../store/actions/profile-actions';
import {structeredExperience} from '../helpers';
import textData from "./text-data";

const propTypes = {
  profile: PropTypes.object.isRequired,
  errors: PropTypes.object.isRequired,
  addExpereriance: PropTypes.func.isRequired,
};
...
export class AddExperience extends Component {
  ...
  handleSubmit = event => {
    ...
    const { history, addExpereriance } = this.props;
...
const AddExperienceWithRouter = withRouter(AddExperience);

export default connect(mapStateToProps, {addExpereriance})(AddExperienceWithRouter);
